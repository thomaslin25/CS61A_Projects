...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.is_container and self.ant.nothing == True and insect.is_container == False:
                    self.ant.contain_ant(insect)
                elif insect.is_container and self.ant.is_container == False:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if self.ant.name == 'Queen' and self.ant.marker or self.ant.is_container and self.ant.contained_ant and self.ant.contained_ant.name == "Queen" and self.ant.contained_ant.marker:
                return 
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while test_place is not hive:
            if random_or_none(test_place.bees) and range <= self.max_range and range >= self.min_range:
...
class LongThrower(ThrowerAnt):
    ...
    armor = 1
    min_range = 5
    max_range = float('inf')   # Change to True to view in the GUI
    # END Problem 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        self.armor -= amount
        if self.armor <= 0:
            for bzz in self.place.bees[:]:
                bzz.reduce_armor(self.damage)               
            self.place.remove_insect(self)
        # END Problem 5
...
class BodyguardAnt(Ant):
    ...
    def __init__(self, armor=2):
        ...
        self.nothing = True  # The Ant hidden in this bodyguard

    def can_contain(self, other):
        # BEGIN Problem 9
        if self.nothing and other != BodyguardAnt:
            return True
        else:
            return False
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.armor = armor
        self.marker = False
        if QueenAnt.queen_presence == False:
            QueenAnt.queen_presence = True
            self.marker = True
        # END Problem 13
    ...
    def action(self, colony):
        ...
        while check_place:
            ...
            elif check_place.ant.is_container: 
                if check_place.ant.name == 'Tank' and check_place.ant.is_doubled == False:
                    check_place.ant.damage *= 2
                    check_place.ant.is_doubled = True
                if check_place.ant.contained_ant and check_place.ant.contained_ant.is_doubled == False:
                    check_place.ant.contained_ant.damage *= 2
                    check_place.ant.contained_ant.is_doubled = True
                check_place = check_place.exit    
            elif check_place.ant.is_doubled:
                check_place = check_place.exit
            else:
                check_place.ant.damage = 2 * check_place.ant.damage
                check_place.ant.is_doubled = True
                check_place = check_place.exit
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        if self.marker and self.armor == 0:
            bees_win()
